                            ...
                            <section class="card-denuncia">
                                ...
                                <div class="cont-info">
                                    ...
                                    <div class="cont-escolha-denuncia">
                                        ...
                                        <button type="button" title="Validar Denúncia" onclick="abrirModalRecusarDenuncia('{{$denuncia->idDenuncia}}', `{{route('recusar.denuncia', ['idDenuncia' => ':idDenuncia'])}}`)" class="btn-close"><i class="fa-solid fa-xmark"></i></button>
                                    </div>
